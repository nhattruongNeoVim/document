...
public class BillManagement {
    ...
    do {
      ...
      case "4":
        ...
        if (bills.isEmpty()) {
          ...
          bills.stream().sorted(Comparator.comparing(Bill::getCreatedDate))
   ...
   */
  private static boolean checkProductExist(final List<Item> items,
      final String productName) {
    boolean check = items.stream()
        .anyMatch((Item item) -> productName.equals(item.getProductName()));
    return check;
  }
